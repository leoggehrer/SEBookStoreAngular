//@CodeCopy
#if ACCOUNT_ON
using SEBookStoreAngular.Logic.Entities.Account;
using SEBookStoreAngular.Logic.Modules.Exceptions;
using SEBookStoreAngular.Logic.Modules.Security;
using System.Text;
using System.Text.RegularExpressions;

namespace SEBookStoreAngular.Logic.Modules.Account
{
    using PasswordRules = CommonModules.Security.PasswordRules;
    using Error = CommonModules.Exceptions.ErrorType;
    using System.Reflection;
    using SEBookStoreAngular.Common.Modules.ThreadSafe;
