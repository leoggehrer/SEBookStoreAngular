//@CodeCopy
using SEBookStoreAngular.Common.Modules.Exceptions;
using SEBookStoreAngular.Logic.Contracts;
using System.Reflection;

namespace SEBookStoreAngular.Logic.DataContext
{
    /// <summary>
    /// Represents the database context for the SEBookStoreAngular application.
    /// </summary>
    internal sealed partial class ProjectDbContext : DbContext, IContext
    {
        ...
        /// </summary>
        private static readonly string ConnectionString = "data source=SEBookStoreAngular.db";
        #endregion fields
